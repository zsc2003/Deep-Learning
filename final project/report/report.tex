...
\title{Generalizable 3D Foundation Models: Advancements in Geometry and View Synthesis}
...
\author{Shouchen Zhou \\
    Tsinghua University \\
    2025213446 \\
    \texttt{zhousc25@mails.tsinghua.edu.cn} \\
}
...
\input{section/3_geometric}
\input{section/4_novel_view}
\input{section/5_conclusion}

\newpage
\input{section/6_reference}
